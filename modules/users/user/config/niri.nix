	...
	flake.homeModules.niri = {  pkgs, ... }: {
		...
		programs.niri.settings = {
			...
			layout = {
				...
				focus-ring.width = 1.0;
				focus-ring.active.color = "#555555";
			...
			spawn-at-startup = [
				{ command = [ "swayidle" "-w" "timeout" "600" "niri msg action power-off-monitors" "resume" "niri msg action power-on-monitors" ]; }
			];
			...
			binds = {
				...
				"Mod+D".action.spawn = [ "~/.config/fuzzel/scripts/fuzzel-status.sh" ];
